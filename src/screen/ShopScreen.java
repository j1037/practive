...
public class ShopScreen extends Screen {
	...
	public enum shopstates {
		SHOP_INVEN, SHOP_RET, SHOP_MODAL,  SHOP_CHECK, SHOP_APPLY
	}
	...
	private void draw() {
		...
		else if(this.state == shopstates.SHOP_CHECK && this.checkoption == 0){
			drawManager.drawShopCheck(this, "Not enough coins!",  shopmodaltype.SM_YESNO);
		}
		else if(this.state == shopstates.SHOP_CHECK && this.checkoption == 1){
			drawManager.drawShopCheck(this, "Purchase Success!",  shopmodaltype.SM_YESNO);
		}
